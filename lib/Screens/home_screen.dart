...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final DateFormat _dateFomatter = DateFormat("MMM dd, yyyy");
      ...
      child: Column(
        children:[
          ListTile(
            ...
            subtitle: Text('${_dateFomatter.format(note.date!)} - ${note.priority}',
            style: TextStyle(
              fontSize: 15.0,
                color: Colors.black,
                decoration: note.status == 0
          ...
          Divider(height: 5.0, color: Colors.amber, thickness: 2.0,),
        ],
      ),
    );
  }
